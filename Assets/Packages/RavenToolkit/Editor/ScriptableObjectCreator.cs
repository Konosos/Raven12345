...
public class ScriptableObjectCreator<T> : VisualElement where T : ScriptableObject
{
    ...
    private readonly string CreationPath;
    private bool IsExpanded = true;

    public ScriptableObjectCreator(SerializedProperty Property, string Title, string CreationPath)
    {
        VisualTreeAsset asset = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Packages/com.raven12345.raventoolkit/Editor/ScriptableObjectCreator.uxml");
