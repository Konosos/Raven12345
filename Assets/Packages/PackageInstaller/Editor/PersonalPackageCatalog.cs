...
namespace Raven12345
{
    ...
    public sealed class PersonalPackageCatalog : ScriptableObject
    {
        ...
        public static IEnumerable<PersonalPackageDefinition> DefaultPackages()
        {
            ...
            yield return new PersonalPackageDefinition { displayName = "RavenConsole", packageId = "com.raven12345.ravenconsole", gitUrl = repository + "RavenConsole", description = "Runtime TextMeshPro command console with command discovery, execution, logging, and suggestions." };
